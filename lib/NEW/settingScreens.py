...
def JSON(Section):
    ...
    if 'Display' in Section:
        Data = [{'type': 'FixedOptions', 'options': ['24 hr', '12 hr'],
                ...
                {'type': 'TextScale', 'title': 'Text size display scale',
                 'desc': 'Set the console text size display scale', 'section': 'Display', 'key': 'TextScale'},
                {'type': 'bool', 'desc': 'Switch console to use Always On Mode',
                 'title': 'Always On Mode', 'section': 'Display', 'key': 'AlwaysOn'},
        ...
        Data =  [{'type': 'ScrollOptions', 'options': ['Forecast', 'Temperature', 'WindSpeed', 'SunriseSunset', 'MoonPhase', 'Rainfall', 'Lightning', 'Barometer'], 'title': 'Panel One',
                  'desc': 'Set primary display for Panel One', 'section': 'PrimaryPanels', 'key': 'PanelOne'},
                 {'type': 'ScrollOptions', 'options': ['Forecast', 'Temperature', 'WindSpeed', 'SunriseSunset', 'MoonPhase', 'Rainfall', 'Lightning', 'Barometer'], 'title': 'Panel Two',
                  'desc': 'Set primary display for Panel Two', 'section': 'PrimaryPanels', 'key': 'PanelTwo'},
                 {'type': 'ScrollOptions', 'options': ['Forecast', 'Temperature', 'WindSpeed', 'SunriseSunset', 'MoonPhase', 'Rainfall', 'Lightning', 'Barometer'], 'title': 'Panel Three',
                  'desc': 'Set primary display for Panel Three', 'section': 'PrimaryPanels', 'key': 'PanelThree'},
                 {'type': 'ScrollOptions', 'options': ['Forecast', 'Temperature', 'WindSpeed', 'SunriseSunset', 'MoonPhase', 'Rainfall', 'Lightning', 'Barometer'], 'title': 'Panel Four',
                  'desc': 'Set primary display for Panel Four', 'section': 'PrimaryPanels', 'key': 'PanelFour'},
                 {'type': 'ScrollOptions', 'options': ['Forecast', 'Temperature', 'WindSpeed', 'SunriseSunset', 'MoonPhase', 'Rainfall', 'Lightning', 'Barometer'], 'title': 'Panel Five',
                  'desc': 'Set primary display for Panel Five', 'section': 'PrimaryPanels', 'key': 'PanelFive'},
                 {'type': 'ScrollOptions', 'options': ['Forecast', 'Temperature', 'WindSpeed', 'SunriseSunset', 'MoonPhase', 'Rainfall', 'Lightning', 'Barometer'], 'title': 'Panel Six',
                  'desc': 'Set primary display for Panel Six', 'section': 'PrimaryPanels', 'key': 'PanelSix'}
                 ]
    elif 'Secondary' in Section:
        Data =  [{'type': 'ScrollOptions', 'options': ['None', 'Forecast', 'Temperature', 'WindSpeed', 'SunriseSunset', 'MoonPhase', 'Rainfall', 'Lightning', 'Barometer'], 'title': 'Panel One',
                  'desc': 'Set secondary display for Panel One', 'section': 'SecondaryPanels', 'key': 'PanelOne'},
                 {'type': 'ScrollOptions', 'options': ['None', 'Forecast', 'Temperature', 'WindSpeed', 'SunriseSunset', 'MoonPhase', 'Rainfall', 'Lightning', 'Barometer'], 'title': 'Panel Two',
                  'desc': 'Set secondary display for Panel Two', 'section': 'SecondaryPanels', 'key': 'PanelTwo'},
                 {'type': 'ScrollOptions', 'options': ['None', 'Forecast', 'Temperature', 'WindSpeed', 'SunriseSunset', 'MoonPhase', 'Rainfall', 'Lightning', 'Barometer'], 'title': 'Panel Three',
                  'desc': 'Set secondary display for Panel Three', 'section': 'SecondaryPanels', 'key': 'PanelThree'},
                 {'type': 'ScrollOptions', 'options': ['None', 'Forecast', 'Temperature', 'WindSpeed', 'SunriseSunset', 'MoonPhase', 'Rainfall', 'Lightning', 'Barometer'], 'title': 'Panel Four',
                  'desc': 'Set secondary display for Panel Four', 'section': 'SecondaryPanels', 'key': 'PanelFour'},
                 {'type': 'ScrollOptions', 'options': ['None', 'Forecast', 'Temperature', 'WindSpeed', 'SunriseSunset', 'MoonPhase', 'Rainfall', 'Lightning', 'Barometer'], 'title': 'Panel Five',
                  'desc': 'Set secondary display for Panel Five', 'section': 'SecondaryPanels', 'key': 'PanelFive'},
                 {'type': 'ScrollOptions', 'options': ['None', 'Forecast', 'Temperature', 'WindSpeed', 'SunriseSunset', 'MoonPhase', 'Rainfall', 'Lightning', 'Barometer'], 'title': 'Panel Six',
